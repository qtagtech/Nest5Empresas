...
class gsp_nest5Empresas_companydevices_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/devices.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(16)
expressionOut.print(element?.name ?: "Dispositivo Sin Nombre")
printHtmlPart(17)
invokeTag('formatDate','g',88,['date':(element?.registeredOn),'type':("datetime"),'style':("LONG"),'timeStyle':("SHORT"),'locale':("es_CO")],-1)
printHtmlPart(17)
expressionOut.print(element?.uid)
printHtmlPart(17)
invokeTag('formatNumber','g',90,['number':(element?.maxSale),'type':("number"),'maxFractionDigits':("0")],-1)
printHtmlPart(17)
expressionOut.print(element?.currentSale)
printHtmlPart(18)
expressionOut.print(createLink(controller: 'company',action: 'editDevice',params: [id: element?.uid]))
printHtmlPart(19)
i++
}
}
...
public static final long LAST_MODIFIED = 1402794527451L
