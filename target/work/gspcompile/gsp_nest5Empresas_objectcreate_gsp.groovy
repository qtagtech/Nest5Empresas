...
class gsp_nest5Empresas_objectcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/object/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(objectInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(objectInstance)],2)
printHtmlPart(19)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1407989749292L
