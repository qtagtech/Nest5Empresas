...
class gsp_nest5Empresas_companyingredientCategories_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/ingredientCategories.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
expressionOut.print(createLink(controller: 'company',action: 'editIngredientCategory',params: [id: element?.syncId]))
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1408035429644L
