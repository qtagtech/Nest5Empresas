...
class gsp_nest5Empresas_companyaddTax_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/addTax.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
invokeTag('require','r',23,['modules':("elastic,inputlimiter,maskedinput,bootstrapswitch,uniform,globalize,colorpicker,timentry,select2,duallistbox,bbq,formwizard,formvalidation")],-1)
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1407989749002L
