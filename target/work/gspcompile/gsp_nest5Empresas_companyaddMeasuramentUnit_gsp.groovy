...
class gsp_nest5Empresas_companyaddMeasuramentUnit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/addMeasuramentUnit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
invokeTag('require','r',23,['modules':("uniform,select2,validate,bbq,form,formwizard,formvalidation,nextindom")],-1)
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1402794527433L
