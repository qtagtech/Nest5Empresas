...
class gsp_nest5Empresas_companytables_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/tables.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('require','r',16,['modules':("tables")],-1)
printHtmlPart(5)
})
...
public static final long LAST_MODIFIED = 1402794527499L
