...
class gsp_nest5Empresas_companycreateSeller_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/createSeller.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
expressionOut.print(createLink(controller: 'seller', action: 'saveFromCompany'))
printHtmlPart(9)
...
public static final long LAST_MODIFIED = 1409609987093L
