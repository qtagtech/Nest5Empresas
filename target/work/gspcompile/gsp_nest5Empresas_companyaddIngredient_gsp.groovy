...
class gsp_nest5Empresas_companyaddIngredient_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/addIngredient.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
invokeTag('require','r',18,['modules':("elastic,inputlimiter,maskedinput,bootstrapswitch,uniform,globalize,colorpicker,timentry,select2,duallistbox,bbq,formwizard,formvalidation")],-1)
printHtmlPart(6)
})
...
invokeTag('script','r',368,[:],2)
printHtmlPart(1)
})
invokeTag('captureBody','sitemesh',370,[:],1)
printHtmlPart(23)
}
...
public static final long LAST_MODIFIED = 1407989748961L
