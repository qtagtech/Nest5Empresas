...
class gsp_nest5Empresas_companyeditProductCategory_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/editProductCategory.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(15)
expressionOut.print(element?.table ?: 'product_category')
printHtmlPart(16)
...
public static final long LAST_MODIFIED = 1402794527468L
