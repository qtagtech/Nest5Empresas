...
class gsp_nest5Empresas_universeedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/universe/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(universeInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(universeInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(universeInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(universeInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1402794527597L
