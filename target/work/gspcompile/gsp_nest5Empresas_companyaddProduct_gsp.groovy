...
class gsp_nest5Empresas_companyaddProduct_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/addProduct.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('script','r',562,[:],2)
printHtmlPart(1)
})
invokeTag('captureBody','sitemesh',563,[:],1)
printHtmlPart(29)
}
...
public static final long LAST_MODIFIED = 1402794527436L
