...
class gsp_nest5Empresas_categorycreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(categoryInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(categoryInstance)],2)
printHtmlPart(19)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1407989748926L
