...
class gsp_nest5Empresas_companyinformation_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/information.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(24)
expressionOut.print(createLink(controller: 'company',action: 'saveInfo'))
printHtmlPart(25)
})
invokeTag('script','r',208,[:],2)
printHtmlPart(1)
})
...
public static final long LAST_MODIFIED = 1402794527470L
