...
class gsp_nest5Empresas_companyeditDevice_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/company/editDevice.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
expressionOut.print(element?.uid ?: 0000000000)
printHtmlPart(15)
expressionOut.print(element?.name ?: "Sin Nombre")
printHtmlPart(16)
invokeTag('formatDate','g',91,['date':(element?.registeredOn ?: new Date()),'type':("datetime"),'style':("LONG"),'timeStyle':("SHORT"),'locale':("es_CO")],-1)
printHtmlPart(17)
expressionOut.print(element?.resolutionMessage ?: "")
printHtmlPart(18)
expressionOut.print(element?.prefix ?: "")
printHtmlPart(19)
expressionOut.print(element?.currentSale ?: 0)
printHtmlPart(20)
invokeTag('formatNumber','g',115,['number':(element?.maxSale ?: 0),'type':("number"),'maxFractionDigits':("0")],-1)
printHtmlPart(21)
createTagBody(2, {->
printHtmlPart(22)
expressionOut.print(element?.currentSale ?: 0)
printHtmlPart(23)
expressionOut.print(createLink(controller: 'company',action: 'saveDevice'))
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1407989749054L
