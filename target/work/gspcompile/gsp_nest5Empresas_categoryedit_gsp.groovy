...
class gsp_nest5Empresas_categoryedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(categoryInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(categoryInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1402794527396L
