...
<head>
    <meta charset="utf-8">
    <title>Nest5 - Maneja tu negocio desde la nube</title>

    <!--=================================
Meta tags
=================================-->

    <meta name="description" content="Nest5 es un sistema de control de punto de venta (POS) con el que podrás manejar las ventas, inventarios y clientes de tu negocio desde cualquier lugar.">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="btnpanel" style="color:#ffffff; background-color:#f59343" href="${createLink(controller:'company',action:'dashboard')}">${message(code:'pos.menu.panel', default:"Translating please change your browser language")}</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
...
<section id="home">
    ...
    <div class="slider-wrapper">
        <div id="img_ipad" style="display:none; position: relative; z-index: 8;"><img class="device-img" src="${resource(dir:'posfiles/img/slider',file:'1.png')}" alt=""/></div>
...
<section id="about">
    <div class="container">
        <div class="section-head">
            <h2>${message(code:'pos.about.title', default:"Translating please change your browser language")}</h2>
...
<section id="services">
    <div class="container">
        <div class="section-head">
            <h2>${message(code:'pos.facilidades.title', default:"Translating please change your browser language")}</h2>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="service"> <span class="mobileIcon"></span>
                        <h3>${message(code:'pos.facilidades.disenotitle', default:"Translating please change your browser language")}</h3>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="service"> <span class="screwIcon"></span>
                        <h3>${message(code:'pos.facilidades.nubetitle', default:"Translating please change your browser language")}</h3>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="service"> <span class="beakerIcon"></span>
                        <h3>${message(code:'pos.facilidades.conectividadtitle', default:"Translating please change your browser language")}</h3>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="service"> <span class="headphoneIcon"></span>
                        <h3>${message(code:'pos.facilidades.economicotitle', default:"Translating please change your browser language")}</h3>
...
<section id="records">
    <div class="container">
        <div class="row">
            <div class="section-head">
                <h2>${message(code:'pos.trabajo.title', default:"Translating please change your browser language")}</h2>
            </div>
            <div class="records-wrapper">
                <div class="record animate1"> <span class="coffeecupIcon"></span>
                    <h5><span data-total="4526" class="stat">4526</span>${message(code:'pos.trabajo.tazas', default:"Translating please change your browser language")}</h5>
                    <div class="clearfix"></div>
                </div>
                <!--\\record-->

                <div class="record animate2"> <span class="meterIcon"></span>
                    <h5><span data-total="3840" class="stat">3840</span>${message(code:'pos.trabajo.horas', default:"Translating please change your browser language")}</h5>
                    <div class="clearfix"></div>
                </div>
                <!--\\record-->

                <div class="record animate3"> <span class="laptopIcon"></span>
                    <h5><span data-total="1842" class="stat">1842</span>${message(code:'pos.trabajo.almuerzos', default:"Translating please change your browser language")}</h5>
                    <div class="clearfix"></div>
                </div>
                <!--\\record-->

                <div class="record animate4"> <span class=" happyIcon"></span>
                    <h5><span data-total="8634" class="stat">8634</span>${message(code:'pos.trabajo.sonrisas', default:"Translating please change your browser language")}</h5>
                    <div class="clearfix"></div>
                </div>
                <!--\\record-->
            </div>
...
<section id="team">
    <div class="container">
        <div class="section-head">
            <h2>${message(code:'pos.equipo.title', default:"Translating please change your browser language")}</h2>
        </div>
        ...
        <div class="team-wrapper">
            ...
            <div class="member"> <img src="${resource(dir:'posfiles/img/team',file:'3.png')}" alt="">
                <div class="hover">
                    <h2>Fabián Zapata</h2>
                    <h5>FRONT END & UI / UX DESIGNER</h5>
                    <p style="font-size: 12pt; line-height: 120%;">${message(code:'pos.equipo.fabian', default:"Translating please change your browser language")}</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3">
                <h3>${message(code:'pos.contacto.nosotrostitle', default:"Translating please change your browser language")}</h3>
                <p>${message(code:'pos.contacto.nosotrostext', default:"Translating please change your browser language")}</p>
                <h3>${message(code:'pos.contacto.social', default:"Translating please change your browser language")}</h3>
            ...
            <div class="col-lg-4 col-md-5 col-sm-5">
                <h3>${message(code:'pos.contacto.map', default:"Translating please change your browser language")}</h3>
                <div id="contact-map" data-address="6.207688,-75.56768" data-zoomlvl="13" data-maptype="HYBRID"></div>
            </div>
            <div class="col-lg-5 col-md-4 col-sm-4">
                <h3>${message(code:'pos.contacto.hello', default:"Translating please change your browser language")}</h3>
