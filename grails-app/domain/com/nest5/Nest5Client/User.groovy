...
//    static mappedBy = [refCodes: 'referer',coupons: "user",friends: "user1", isFriendOf: "user2"]
    static hasMany = [brands:Relation/*achievements : Achievements,*//*refCodes: RefCodes,stamps:Stamp,,coupons: Coupon,chats: Message,friends: Friendship, isFriendOf: Friendship,media: Media*/]
