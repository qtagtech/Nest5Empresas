   ...
   def springSecurityService
    ...
    def userLike(){
        ...
        switch(params.element){
            case "object": element = java.lang.Object.findById(params.elementid)
                break
            case "category": element = groovy.lang.Category.findById(params.elementid)
                break
    ...
    def listCategory(){
        ...
        def max = params.max ? params.max as Integer : 10
        def offset = params.offset ? params.offset as Integer : 0
        def lista = groovy.lang.Category.findAll([max: max, offset: offset])
    ...
    def listObject(){
        ...
        def max = params.max ? params.max as Integer : 10
        def offset = params.offset ? params.offset as Integer : 0
        def lista = java.lang.Object.findAll([max: max, offset: offset])
        def result = [length: 0, elements: []]
