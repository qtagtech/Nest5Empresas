...
//    @Secured(["ROLE_ADMIN"])
    def list() {
        ...
        [categoryInstanceList: groovy.lang.Category.list(params), categoryInstanceTotal: groovy.lang.Category.count()]
    }

//    @Secured(["ROLE_ADMIN"])
    def create() {
        [categoryInstance: Category(params)]
    }
...
//    @Secured(["ROLE_ADMIN"])
    def show() {
        def categoryInstance = groovy.lang.Category.get(params.id)
        if (!categoryInstance) {
        ...
        if (params.version) {
            ...
            if (categoryInstance.version > version) {
                categoryInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                        [message(code: 'category.label', default: 'Category')] as java.lang.Object[],
