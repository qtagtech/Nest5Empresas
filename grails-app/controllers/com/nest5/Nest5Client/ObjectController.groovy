...
class ObjectController {
    ...
    def list(Integer max) {
        ...
        [objectInstanceList: java.lang.Object.list(params), objectInstanceTotal: java.lang.Object.count()]
    }

    def create() {
        [objectInstance: new java.lang.Object(params)]
    }

    def save() {
        def objectInstance = new java.lang.Object(params)
    ...
    def show(Long id) {
        def objectInstance = java.lang.Object.get(id)
        if (!objectInstance) {
        ...
        if (version != null) {
            if (objectInstance.version > version) {
                objectInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                        [message(code: 'object.label', default: 'Object')] as java.lang.Object[],
